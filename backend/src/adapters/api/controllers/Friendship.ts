...
import { IFriendshipRequest } from '../middlewares/Friendship';
...
export const createFriendshipRequest = async (req: Request<{}, {}, IFriendshipRequest>, res: Response) => {
...
export const acceptFriendshipRequest = async (req: Request<{}, {}, IFriendshipRequest>, res: Response) => {
  const friendshipServices: IFriendshipServices = new FriendshipServices();
  const { userId, friendId }: IFriendshipRequest = req.body;
  try {
...
export const rejectFriendshipRequest = async (req: Request<{}, {}, IFriendshipRequest>, res: Response) => {
  const friendshipServices: IFriendshipServices = new FriendshipServices();
  const { userId, friendId }: IFriendshipRequest = req.body;
  try {
...
export const deleteFriendship = async (req: Request<{}, {}, IFriendshipRequest>, res: Response) => {
  const friendshipServices: IFriendshipServices = new FriendshipServices();
  const { userId, friendId }: IFriendshipRequest = req.body;
  try {
